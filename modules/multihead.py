...
# max_len = 91  代表有91个嵌入维度
def positional_encoding(inputs,batch_time,
                        maxlen=91,
                        masking=True,
                        scope="positional_encoding"):
    '''Sinusoidal Positional_Encoding. See 3.5
    inputs: 3d tensor. (N, T, E) batch_size,time_steps,embedding_size
    ...
    with tf.variable_scope(scope, reuse=tf.AUTO_REUSE):
        ...
        position_ind = batch_time  # 通过day time构造位置嵌入维度，相同的一天具有相同的嵌入维度
